...
class SucceedProject extends Page
{
  ...
  public $content = '';
  public $title = "CannaLogs - Succeed Project";
  public $keywords = "CannaLogs, succeed project";
  ...
  /**
   * succeed - Set the project status to Cancelled.
   *
   * @param  int $id
   *
   * @return void
   */
  private function succeed( $id )
  {
    ...
    <div class="container alert alert-success alert-dismissible text-center" role="alert"">
      <button type = "button" class="close" data-dismiss="alert">x</button>
        Successfully succeeded project!
    </div>
    ';
